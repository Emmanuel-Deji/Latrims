<template>
    <div class="wrapper">
        ...
        <div class="showcase container">
          <div class="pshowcase__txt">
            <div style="display: flex; gap: 3px; margin-bottom: -0.5 !important">
              <b-img src="~/assets/cloudServices/Cloud-service-management-icon.png"
                        alt="Fluid image"
                        srcset=""
              ...
              <h1 class="digital">Cloud Services</h1>
            </div>
            <hr class="dthr">
      ...
      <div class="container">
      <div class="where">
        You are here: <a href="/" style="color: #e04b26">Home</a> / Cloud Services
      </div>
    </div>
      <div class="container">
            ...
            <b-col class="table-header">
              <div class="section3b">
                <div class="side1">
                  <div class="dita">
                    <b-img
                      src="~/assets/cloudServices/Cloud-Strategy-_-Business-Migratio (1).png"
                      alt="Fluid image"
                      srcset=""
                      class="reduced-costs img pt-2"
                      style="width: 25%"
                    ></b-img>
                    <div>
                        <p class="here-top">Cloud Strategy & Business Migration</p>
                    </div>
                  </div>
                  <div class="dita">
                    <img
                      src="~/assets/cloudServices/Cloud-Readiness-Assessment (1).png"
                      alt=""
                      srcset=""
                      class="reduced-costs img pt-2"
                      style="width: 25%"
                    />
                    <p class="here-top">Cloud Readiness Assessment</p>
                  </div>
                  <div class="dita">
                    <img
                      src="~/assets/cloudServices/Cloud-Infrastructure-Management (1).png"
                      alt=""
                      srcset=""
                      class="reduced-costs img pt-2"
                      style="width: 25%"
                    />
                    <p class="here-top">Cloud Infrastructure Management</p>
                  </div>
                </div>
                <div class="side2">
                  <div class="dita">
                    <img
                      src="~/assets/cloudServices/Transition-Management (1).png"
                      alt=""
                      srcset=""
                      class="reduced-costs img pt-2"
                      style="width: 25%"
                    />
                    <p class="here-top">Transition Management</p>
                  </div>
                  <div class="dita">
                    <img
                      src="~/assets/cloudServices/Cloud-Efficiency-Improvement (1).png"
                      alt=""
                      srcset=""
                      class="reduced-costs img pt-2"
                      style="width: 25%"
              ...
              <div >
                <div class="section3_img">
                  <b-img
                  src="~/assets/latrims/cloud_service.png"
                  fluid-grow
                  alt="Fluid image"
        ...
        <div class="section5">
          ...
          <div class="cards">
            ...
            <!-- <div class="cardA">
              <div class="card-img">
                <img
                  src="~/assets/cloudServices/micorosft-planner-icon.png"
                  alt=""
                  srcset=""
                  class="reduced-costs img pt-2"
                />
      ...
      <b-container class="container">
       ...
       <b-container class="bv-example-row">
        ...
        <div class="side1" style="display: flex; gap: 2rem; width: 100%;">
          <div>
            <h1 class="num">04</h1>
